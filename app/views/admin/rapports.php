<div class="card">
    ...
    <div id="add-rap-form" style="display:none; background-color: var(--bg-color); padding: 20px; border-radius: 8px; margin-bottom: 25px; border: 1px solid var(--border);">
        ...
        <form hx-post="<?= BASE_URL ?>/admin/rapports/add" hx-target="#main-content">
            <div class="form-group mb-0">
                <label>Bilan de l'activité</label>
                <textarea name="bilan_activite" class="form-control" rows="5" required placeholder="Décrivez votre journée : les tâches accomplies, les ventes, les difficultés, etc."></textarea>
            </div>
